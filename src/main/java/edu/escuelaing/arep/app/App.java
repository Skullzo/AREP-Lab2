    ...
    */
    private static String inputDataPage(Request req, Response res) {
        String pageContent
        	    ...
        	    + "</div>"
                + "<input style=\"width:500px ; font-size:150% ; position:absolute ; top:237px ; text-align:center; left:720px\" type=\"text\" name=\"Datos\">"
                + "<br><br>"
                + "<input style=\"width:508px ; font-size:150% ; position:absolute ; top:272px ; text-align:center; left:720px\" type=\"submit\" value=\"Calcular Media y Desviacion Estandar\">"
                + "</form>"
                + "<br><br>"
                + "<br><br>"
                + "<br><br>"
