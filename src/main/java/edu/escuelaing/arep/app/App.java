    ...
    */
    private static String inputDataPage(Request req, Response res) {
        String pageContent
        	    ...
        	    + "</div>"
                + "<form action=\"/results\">"
                + "<div style=\"padding:30px; width:96.9%; background:#008000; color:white; font-size:200%; position:absolute ; top:300px ; left:0px\">"
        		+ "<center>Ingrese los números separados por una coma sin espacios. (Ejemplo: 1,2,3,4,5)</center>"
        	    + "</div>"
