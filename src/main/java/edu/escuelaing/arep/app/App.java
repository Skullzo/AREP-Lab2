    ...
    */
    private static String inputDataPage(Request req, Response res) {
        String pageContent
        	    ...
        	    + "</div>"
                + "<center><input style=\"width:500px ; font-size:150% ; position:absolute ; top:237px ; text-align:center; left:720px\" type=\"text\" name=\"Datos\"><center>"
                + "<br><br>"
                + "<center><input style=\"width:508px ; font-size:150% ; position:absolute ; top:272px ; text-align:center; left:720px\" type=\"submit\" value=\"Calcular Media y Desviacion Estandar\"></center>"
                + "</form>"
                + "<br><br>"
                + "<br><br>"
                + "<br><br>"
    ...
    */
    private static String resultsPage(Request req, Response res) {
        ...
        String pageResponse
        	    ...
        	    + calculos[0]
                + "</div>"
                + "<div style=\"padding:30px; width:96.9%; background:#005a80; color:white; font-size:200%; position:absolute ; top:320px ; left:0px\">"
