    ...
    */
    private static String inputDataPage(Request req, Response res) {
        String pageContent
        	    ...
        	    + "</div>"
                + "<input style=\"width:500px ; font-size:150% ; position:absolute ; top:237px ; left:750px\" type=\"text\" name=\"Datos\">"
                + "<br><br>"
                + "<input style=\"width:501px ; font-size:150% ; position:absolute ; top:277px ; left:750px\" type=\"submit\" value=\"Calcular Media y Desviacion Estandar\">"
                + "</form>"
