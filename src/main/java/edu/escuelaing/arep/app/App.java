    ...
    */
    private static String inputDataPage(Request req, Response res) {
        String pageContent
        	    ...
        	    + "</div>"
                + "<input style=\"width:500px ; font-size:150% ; position:absolute ; top:236px ; left:800px\" type=\"text\" name=\"Datos\">"
                + "<br><br>"
                + "<input style=\"width:500px ; font-size:150% ; position:absolute ; top:336px ; left:800px\" type=\"submit\" value=\"Calcular Media y Desviacion Estandar\">"
                + "</form>"
