    ...
    */
    private static String inputDataPage(Request req, Response res) {
        String pageContent
                ...
                + "<body style = \"background: url(https://blog.hdwallsource.com/wp-content/uploads/2017/05/desk-calculator-wallpaper-61252-63066-hd-wallpapers.jpg) no-repeat ; background-size: 102% 100%;\">"
                + "</body>"
                + "<body>"
                + "<div style=\"padding:30px; width:100%; color:white; font-size:500%;\">"
        		+ "<center>Calculadora de Media y Desviación Estándar</center>"
        	    + "</div>"
                + "<form action=\"/results\">"
