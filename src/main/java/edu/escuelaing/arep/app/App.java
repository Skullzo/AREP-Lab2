    ...
    */
    private static String inputDataPage(Request req, Response res) {
        String pageContent
                ...
                + "<body style = \"background: url(https://blog.hdwallsource.com/wp-content/uploads/2017/05/desk-calculator-wallpaper-61252-63066-hd-wallpapers.jpg) no-repeat ; background-size: 150% 150%;\">"
                + "</body>"
                + "<body>"
                + "<div style=\"padding:30px; width:97%; background:#008000; color:white; font-size:500%; position:absolute ; top:0px ; left:0px\">"
